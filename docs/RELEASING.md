...
4. Run `RELEASE_TAG=v0.0.6 npm run release:check` and `npm run verify`.
5. Open a release pull request titled `chore: release v0.0.6` and merge only
...
```sh
git tag -a v0.0.6 -m "On Track v0.0.6"
